...
<body>
       ...
       <?php 
            foreach($faq as $value){
                //var_dump($value);
                echo $value['domanda'].$value['risposta'];
            }
       ?>
        <!-- <h2>
